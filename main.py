...
button10 = ttk.Button(root, text='Quit Game',command = quitApp)
button10.grid(row=0, column = 3 , ipadx =10, ipady=10)

button11 = ttk.Button(root, text='Rematch', command = rematchGame)
button11.grid(row =1 ,column = 3, ipadx=10, ipady=10)
